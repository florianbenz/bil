/**
* \file CRC32.cpp
* \brief Contains definition of CRC32 functions.
*/
...
// Lookup table for the CRC32 values of the 256 possible values of 8 bit.
// These CRC32 values were calculated with the generator polynomial
// 0x82f63b78, i.e. the reversed Castagnoli polynomial (0x1edc6f41).
...
// Lookup table for the CRC32 values of the 32 possible values of 5 bit.
// These CRC32 values were calculated with the generator polynomial
// 0x82f63b78, i.e. the reversed Castagnoli polynomial (0x1edc6f41).
...
{
    return (oldCRC >> 8) ^ CRC32_LOOKUP_8BIT[(oldCRC ^ data8Bit) & 0xff];
}


boost::uint32_t bil::calc5BitCRC32(boost::uint32_t oldCRC, boost::uint8_t data5Bit)
{
    return (oldCRC >> 5) ^ CRC32_LOOKUP_5BIT[(oldCRC ^ data5Bit) & 0x1f];
}